...
<head>
    <script type="text/javascript">
        var currentControllerName = 'AdminReply';
        var appPath = '';
                        ...
                        <div class="contPart">
                            <div class="cpLeftPanelMaster">
                                ...
                                <div id="dvWrapper">
                                    ...
                                    <script type="text/javascript" src="/Scripts/dv/experience.js?.V1.0"></script>
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                    ...
                                    <input type="hidden" id="hdnTotalDays" value="0">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-10">
                                                        ...
                                                        <label id="lblEx">Do You have experience?</label>
                                                    </div>
                                                    ...
                                                    <table class="table table-bordered" id="myTblExp">
                                                        ...
                                                        <tbody id="dvExperienceGroup">
                                                            <tr id="trExperience1">
                                                                ...
                                                                <td>
                                                                    <input type="text" id="txtStartDate1" name="ExpFrom"
                                                                        maxlength="10"
                                                                        class="form-control datepicker hasDatepicker"
                                                                        readonly="true">
                                                                </td>
                                                                <td>
                                                                    <input type="text" id="txtEndDate1" name="ExpTo"
                                                                        maxlength="10"
                                                                        class="form-control datepicker hasDatepicker"
                                                                        readonly="true">
                                                                </td>
                                                                ...
                                                                <td hidden="">
                                                                    <input type="text" id="txtIDNO1" name="txtIDNO"
                                                ...
                                                <input type="hidden" id="hdnQualificationExamId" value="1">
                                                <input type="hidden" id="hdnStartDate" value="08/12/2022">
