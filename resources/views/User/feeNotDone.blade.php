                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="card card-default">
                                                                    ...
                                                                    <?php 
                                                                    $fee_amount = Auth::user()->fee_amount * 100;
                                                                    ?>
                                                                    <div class="card-body text-center">
                                                                        <form action="{{ route('user.payment.store') }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            <script
                                                                                src="https://checkout.razorpay.com/v1/checkout.js"
                                                                                data-key="{{ env('RAZORPAY_KEY') }}"
                                                                                data-amount='{{$fee_amount}}' data -
                                                                                buttontext="Online Payment" data -
                                                                                name="GeekyAnts official" data -
                                                                                description="Razorpay payment" data -
                                                                                image="{{asset('img/CollegeLogo.jpg')}}"
                                                                                data - prefill.name="ABC" data -
                                                                                prefill.email="abc@gmail.com" data -
                                                                                theme.color="#ff7529">
                                                                                </script>
                                                                        </form>
                                                                    </div>
                                                            ...
                                                            <script>
                                                                ...
                                                                // when razorpay opens and got text Test Mode on screen remove this from razorpay-backdrop -> span
                                                                var text = document.querySelector('.razorpay-backdrop span');
